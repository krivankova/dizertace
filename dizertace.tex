...
%\begin{comment}
V další části práce se zaměříme na modelování Credit Valuation Adjustment (CVA), což je bankou sledovaná a účtovaná hodnota, která slouží jako úprava reálné hodnoty derivátů o kreditní riziko protistrany.
...
Banky proto hledají nové možnosti, jak snižovat náklady, jakými jsou například opravné položky k úvěrům klientů nebo k finančním derivátům.
...
Navíc si klademe za cíl, aby námi použité metody přinášeli některé nové výhody oproti modelům uvedeným v teoretické části.
...
Navržený model si klade za cíl popsat dynamiku cen aktiv bez nekonzistence předpokladů prezentované v Ohlson-Rosenbergově paradoxu.
...
V dalším části práce bude naším cílem představit a aplikovat model pro CVA úrokových swapů, který respektuje regulační normy a~zároveň přináší nižší ocenění CVA než metody využívané v bankovní praxi.
