...
Avšak externí rating získají pouze velké a renomované společnosti, a proto tuto metodu často nemůžeme použít.
...
\section{Aplikace výpočtu CVA na reálná data}
...
\begin{figure}[!htbp]
  \centering 
%	\includegraphics[width=10cm, clip, trim= 125 280 110 270]{IMG/IRS.pdf}
