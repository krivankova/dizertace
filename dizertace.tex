...
Ze soustavy rovnic \eqref{vahy} vidíme, že čitatel určuje vztah mezi $\boldsymbol{X}$ a $\boldsymbol{\mu}$ a jmenovatel slouží k normování, aby platilo, že součet vah je roven jedné.
...
Naším cílem bude ukázat příklady trajektorií vygenerovaných tímto modelem.
...
Dále nebudeme uvažovat počty akcií a tudíž tržní hodnotu akcie ztotožníme s její tržní cenou.
...
\begin{figure}[!htbp]
  ...
  \caption{Model cen aktiv v portfoliu}  \label{model_cen}
\end{figure}
...
\begin{figure}[!htbp]
  ...
  \caption{Model cen aktiv v portfoliu}  \label{model_cen_jednotlive}
\end{figure}
