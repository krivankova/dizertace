...
\begin{definice}\label{cva_def}
 ...
 \label{CVA}
\end{equation}
 kde $R$ je míra návratnosti, $\hat{e}_d(t)$ je diskontovaná očekávaná expozice v čase $t$ a $PD(t)$ je pravděpodobnost selhání protistrany před časem $t$.
\end{definice}
...
\subsection{Pravděpodobnost selhání a LGD}
\textit{Pravděpodobnost selhání (PD)}, anglicky probability of default, udává v procentech s jakou pravděpodobností dojde k selhání klienta během jednoho roku.
...
Budeme ji značit $R$ a je dána jako
\begin{equation}\label{recovery_rate}
R=1-LGD,
\end{equation}
kde $LGD$  je míra očekávané ztráty daná selhání protistrany.
