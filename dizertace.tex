...
je vektorová funkce $\boldsymbol\alpha:T\times\mathbb{R}^n\to\mathbb{R}^n$.
...
a nechť $\boldsymbol{B}=(\boldsymbol\beta^{1},\dots,\boldsymbol\beta^{m})$ je maticová funkce $\boldsymbol{B}:T\times\mathbb{R}^n\to\mathbb{R}^{n\times m}$.
