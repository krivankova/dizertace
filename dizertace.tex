...
Z vlastnosti normality okamžité úrokové míry můžeme odvodit cenu bezkupónového dluhopisu s nominální hodnotou jedna vyplácenou v čase $T$ pomocí následujícího vztahu.
...
Pro modelování úrokové míry budeme používat Hull-Whitův jednofaktorový model uvedený v Kapitole \ref{H-W_model_kap}.
...
Vzhledem k tomu, že protistrany číslo 3 a číslo 4 mají stejný rating a tedy i stejnou $PD_{1Y}$, tak se jejich PD křivky kryjí.
