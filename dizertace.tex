...
\begin{definice}[Wienerův proces]
...
\textit{Eulerova aproximace} je spojitý stochastický proces, který v daných časech $\{t_n\}_{n=0}^N\subseteq T$ splňuje vztah \eqref{Euler} a mezi těmito časovými body je lineárně interpolovaná hodnota.
