...
Modely krátkodobých úrokových se dělí na jednofaktorové a vícefaktorové.
...
Možnost záporných úrokových měr odstraňuje Cox - Ingersoll - Rossův model (CIR model), který je ve tvaru 
...
Podrobnosti o tomto modelu lze nalézt v již zmiňované publikaci \cite{brigo2007interest}.
