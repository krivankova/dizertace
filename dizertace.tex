...
\begin{equation}\label{risk-free_asset_reseni}
B(t)=B(0)\,\mathrm{e}^{\int_0^t r(s)\,\mathrm{d}s},
\end{equation}
kde $r(t)$ je okamžitá úroková míra a $B(t)$ je cena dluhopisu v~čase~$t$.
...
\frac{B(0)}{B(t)}=\mathrm{e}^{-\int_0^t r(s)\,\mathrm{d}s},
\end{equation}
...
Zaměříme se na modely krátkodobých úrokových měr, jelikož je budeme využívat v další části práce k ocenění derivátů úrokových měr.
