...
V neposlední řadě chceme zmínit význam amerického matematika Norberta Wienera, který dokázal existenci stochastického procesu používaného k popisu Brownova pohybu. 
...
\begin{definice}[Nezávislost přírůstků]
\end{definice}
...
S pravděpodobností jedna je spojitý a zároveň je nediferencovatelný v každém bodě. 
...
Snadno odvodíme vztah pro autokovarianční funkci Wienerova procesu $\mathsf{C}(W(s),W(t))=\min(s,t)$.
Jestliže $0\leq s<t$, pak
\begin{align*}
\mathsf{C}(W(s),W(t))&=\mathsf{E}{\left[(W(s)-\mu_s)(W(t)-\mu_t)\right]} \\
...
Riziko selhání (defaultu), jinak označováno jako riziko protistrany před\-sta\-vuje základní rizikovou složkou kreditního rizika a jeho parametrem je prav\-dě\-po\-dob\-nost neplnění. Definice tohoto jevu není zcela jednoznačná, vět\-ši\-nou se však chápe jako stav finanční tísně, bránící ve splnění závazku.
\\\\\\
Poznámky:\\
\\
Counterparty Credit Risk (CCR) představuje možnost, že banka utrpí ztrátu z derivátového obchodu nebo při financování aktiva, která bude způ\-so\-be\-na defaultem protistrany transakce. 
...
Tato kapitola rozebírá aktuální téma \textit{Kreditní přirážky k  tržnímu riziku} neboli Credit Valuation Adjustment (CVA).

%%%%%%%%%%%%%%%%%%

\subsection{Kreditní riziko protistrany}
Riziko selhání (defaultu), jinak označováno jako riziko protistrany před\-sta\-vuje základní rizikovou složkou kreditního rizika a jeho parametrem je prav\-dě\-po\-dob\-nost neplnění. 
...
Ratingy z investičního pásma přiznávají ratingové agentury finanční instrumentům, do kterých doporučují investovat. Pod touto úrovní leží pásmo spekulativních investic, u kterých je očekáváno zanačné riziko ztráty.
...
\section{Kreditní přirážka k tržnímu riziku}
\textit{Kreditní přirážky k  tržnímu riziku} neboli Credit Valuation Adjustment (CVA)..
