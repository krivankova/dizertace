...
\subsection{Simulace úrokových měr}
...
Při oceňování IRS používáme Monte Carlo simulace.
...
Parametry modelu $\alpha$ a $\sigma$ odhadneme z historických dat tříměsíční sazby PRIBOR ($\alpha=0,0208$ a $\sigma=0,015$).
...
Pro každý scénář provedeme ocenění IRS v každém datu simulace v budoucnosti.
