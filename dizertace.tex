...
V další části se generuje počáteční výnosová křivka, která se dále využívá při modelování úrokové míry pomocí Hull-Whitova modelu (viz Kapitola~\ref{vynosova_krivka_kap}).
...
Potom vykreslí graf vývoje tříměsíční sazby PRIBOR a odhadne z ní parametry Hull-Whitova modelu (viz Kapitola \ref{simulace_kap}).
\begin{verbatim}
% =============================================================
% Načte data o PRIBOR
% =============================================================
