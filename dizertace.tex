...
The methods are applied in two areas -- the portfolio theory and the theory of financial risk management.
The dissertation compares the classic and dynamic approach to portfolio theory.
It deals with assumptions inconsistencies in commonly used dynamic model and Ohlson-Rosenberger's paradox is formulated.
The main attention is focused on designing a new model which describes the behavior of financial asset prices and its application to real data.
...
The thesis describes the method of calculation using stochastic models, such as the Hull-White model used to describe the behavior of interest rates.
...
Dále nechť $\boldsymbol X_0$ je náhodný vektor, který může být závislý pouze na hodnotách Wienerova procesu $\boldsymbol W(t_0)$ v čase $t_0$, %nezávislý na trajektorii Wienerova procesu $\boldsymbol W(t)$ 
a platí
...
\newblock {\em Workshop of the Jaroslav Hájek Center, Book of short
  papers}, Brno: Masarykova univerzita, 2010.
