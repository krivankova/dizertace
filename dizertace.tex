...
\begin{figure}[!htbp]
  \centering 
	\includegraphics[width=12cm, clip, trim= 0 20 25 50]{IMG/data_price_of_asset_ostatni.pdf}
	\includegraphics[width=12cm, clip, trim= 0 20 25 50]{IMG/data_price_of_asset_KBPM.pdf}	
  \caption{Ceny aktiv v portfoliu}  \label{model_price_of_asset}
\end{figure}

\begin{figure}[!htbp]
  \centering 
	\includegraphics[width=12cm, clip, trim= 0 20 25 50]{IMG/return_of_market_v4b.pdf}
  \caption{Model výnosnosti trhu $r(t)$}  \label{return_of_market}
\end{figure}

\begin{figure}[!htbp]
  \centering 
	\includegraphics[width=12cm, clip, trim= 0 20 25 50]{IMG/ds_price_of_asset_ostatni.pdf}
	\includegraphics[width=12cm, clip, trim= 0 20 25 50]{IMG/ds_price_of_asset_KBPM.pdf}	
  \caption{Model cen aktiv v portfoliu}  \label{price_of_asset}
\end{figure}

\begin{figure}[!htbp]
  \centering 
	\includegraphics[width=6.5cm, clip, trim= 0 20 25 0]{IMG/ds_cez_v4.pdf}\quad
	\includegraphics[width=6.5cm, clip, trim= 0 20 25 0]{IMG/ds_o2_v4.pdf}\\	
	\includegraphics[width=6.5cm, clip, trim= 0 20 25 0]{IMG/ds_KB_v4.pdf}\quad
	\includegraphics[width=6.5cm, clip, trim= 0 20 25 0]{IMG/ds_PM_v4.pdf}\\	
	\includegraphics[width=6.5cm, clip, trim= 0 20 25 0]{IMG/ds_Pegas_v4.pdf}\quad
	\includegraphics[width=6.5cm, clip, trim= 0 20 25 0]{IMG/ds_ct_v4.pdf}\\
	\includegraphics[width=6.5cm, clip, trim= 0 20 25 0]{IMG/ds_nwr_v4.pdf}	
  \caption{Model cen aktiv v portfoliu}  \label{price_of_asset}
\end{figure}

\begin{figure}[!htbp]
  \centering 
	\includegraphics[width=12cm, clip, trim= 0 20 25 50]{IMG/ds_weight_of_asset_v4.pdf}
