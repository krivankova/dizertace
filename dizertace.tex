...
Nejběžnější modifikací Wienerova procesu splňující požadavky popsané v~předchozí části je Geometrický Wienerův proces, který v kontextu finanční matematiky použil poprvé Paul Samuelson \cite{samuelson1964rational}.
