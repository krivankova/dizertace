...
Příklady trajektorií procesů popsaných modely \ref{risk_asset_model} a~\ref{risk-free_asset_model} zobrazuje Obrázek~\ref{asset_model_graf}.
...
\begin{equation}\label{samofinancujici_strategie}
\mathrm{d}V(t)=\phi(t)\,\mathrm{d}P(t)+\psi(t)\,\mathrm{d}B(t),
\end{equation}
kde $B(t)$ je , $P(t)$ a $V(t)$.
\end{definice}

\begin{definice}
\textit{Replikační portfolio} $\big(\phi(t),\psi(t)\big)$ je 
